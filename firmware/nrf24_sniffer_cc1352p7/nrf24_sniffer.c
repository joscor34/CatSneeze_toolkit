...
#define NRF24_UART_BAUD         921600u     /* CatSniffer v3 SerialPassthrough fijo a 921600 */
...
int main(void)
{
    ...
    /* ── Configurar antenna switch SKY13317-373LF (CatSniffer V3) ────────────
     * El CC1352P7 usa DIO28/29/30 para controlar el switch de RF front-end.
     * Al mapearlos como RFC_GPO0/1/2, el RF Core los conducirá automáticamente
     * durante TX/RX según el frontEndMode=0x1 (single-ended RFP).
     * Confirmado en simple_central.syscfg oficial: rfAntennaPin0=DIO_28,
     * rfAntennaPin1=DIO_29, rfAntennaPin2=DIO_30.
     */
    IOCPortConfigureSet(IOID_28, IOC_PORT_RFC_GPO0, IOC_IOMODE_NORMAL);
    IOCPortConfigureSet(IOID_29, IOC_PORT_RFC_GPO1, IOC_IOMODE_NORMAL);
    IOCPortConfigureSet(IOID_30, IOC_PORT_RFC_GPO2, IOC_IOMODE_NORMAL);
